...
// @audit-info - different solidity versions are used
...
contract MondrianWallet2 is IAccount, Initializable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // @audit-info - function should be marked as external
     ...
     */
    // @audit-info - empty block should be removed from the codebase
    ...
    function _executeTransaction(Transaction memory _transaction) internal {
        ...
        if (to == address(DEPLOYER_SYSTEM_CONTRACT)) {
            ...
            bool success;
            // @audit - high - this function sends funds to unknown destination
